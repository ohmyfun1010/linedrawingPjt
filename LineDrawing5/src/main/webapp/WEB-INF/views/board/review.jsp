				...
				<div class="d-none d-md-block">
					<ul class="pagination justify-content-center">
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item"><a
									href="${root }board/review?pagepage=${pageButtonBean.prevPage}"
									class="page-link">이전</a></li>
							</c:otherwise>
						</c:choose>
							...
							<c:choose>
								<c:when test="${idx == pageButtonBean.currentPage }">
									<li class="page-item active"><a
										href="${root }board/review?page=${idx}" class="page-link">${idx }</a>
									</li>
								</c:when>
								<c:otherwise>
									<li class="page-item"><a
						...
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item"><a
									href="${root }board/review?page=${pageButtonBean.nextPage}"
									class="page-link">다음</a></li>
							</c:otherwise>
						</c:choose>
